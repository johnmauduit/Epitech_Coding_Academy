                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <ul class="nav-item dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="{{ route('admin_user_index') }}">Users</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin_player_index') }}">Players</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin_team_index') }}">Teams</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin_match_index') }}">Matchs</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin_stat_index') }}">Stats</a></li>
                                        <li><a class="dropdown-item" href="{{ route('admin_bet_index') }}">Bets</a></li>
                                </ul>
                        </li>
                    ...
                    {{-- <div class="dropdown"> --}}
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            @if (Auth::check())
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="{{ '/users/user/'. Auth::user()->id }}">Profile</a>
                                            <li class="nav-item"><a class="nav-link" href="{{ '/bets/user/'. Auth::user()->id }}">My bets</a>
