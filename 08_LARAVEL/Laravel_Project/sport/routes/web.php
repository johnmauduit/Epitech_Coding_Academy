...
//routes des bets
Route::get('/bets/user/{user_id}', 'BetController@show')->name('bet_user_id');
Route::get('/bets/{user_id}/{match_id}', 'BetController@create')->name('bet');
Route::post('/bets/store', 'BetController@store')->name('bet_store');

//routes des admins bets
Route::get('/admin/bets/', 'Admin\AdminBetController@index')->name('admin_bet_index');
Route::get('admin/bets/create/{id}', 'Admin\AdminBetController@create')->name('admin_bet_create');
Route::get('/admin/bets/edit/{id}', 'Admin\AdminBetController@edit')->name('admin_bet_edit');
Route::post('admin/bets/store', 'Admin\AdminBetController@store')->name('admin_bet_store');
Route::get('/admin/bets/delete/{id}', 'Admin\AdminBetController@destroy')->name('admin_bet_delete');


// routes pour les langues

Route::get('/{lang?}/home',  'HomeController@index')->name('lang');